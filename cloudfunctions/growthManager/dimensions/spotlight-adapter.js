...
class SpotlightAdapter extends DimensionAdapterBase {
  ...
  computeKPI(data) {
    if (!data || data.length === 0) return { spotlight_count: 0 }
    return { spotlight_count: data.length }
  }
...
module.exports = SpotlightAdapter
