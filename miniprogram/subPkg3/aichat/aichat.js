...
Page({
  ...
  sendMessage: async function () {
    ...
    try {
      ...
      if (!fullContent) {
        ...
        wx.showToast({ title: '回复生成失败，请重试', icon: 'none' })
        return
      }
  ...
  getSystemPrompt: function (npcType) {
    const prompts = {
      companion: {
        role: 'system',
        content: '你是一位温暖、善解人意的微聊陪伴伙伴。你的职责是倾听用户的心声，给予真诚的情感支持和鼓励。你应该用亲切、自然的语气交流，像朋友一样陪伴用户。不要过于正式或说教，而是用共情的方式回应。当用户遇到困难时，给予建设性的建议；当用户开心时，一起分享喜悦。回答要简洁温暖，充分回应用户的问题和情感。'
      },
      study: {
        role: 'system',
        content: '你是一位专业、耐心的学业顾问。你擅长帮助学生制定学习计划、解答学习困惑、提供高效学习方法。你会根据学生的情况给出针对性的建议，帮助学生建立良好的学习习惯。回答要条理清晰、实用可行，完整解答学生的疑问。'
      },
      counselor: {
        role: 'system',
        content: '你是一位温和、专业的心理辅导员。你善于倾听，能够识别学生的情绪状态，提供适当的心理疏导。当学生感到焦虑、压力或困惑时，你会用专业的心理学方法帮助他们调节情绪、建立积极心态。如果发现可能有严重心理问题的情况，你会温和地建议寻求专业帮助。回答要温暖有力量，给予充分的心理支持和建议。'
      }
    }
