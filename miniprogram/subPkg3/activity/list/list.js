...
Page({
  ...
  onGoDetail: function (e) {
    ...
    wx.navigateTo({ url: `/subPkg3/activity/detail/detail?id=${id}` })
  },

  // 发布活动
  onPublish: function () {
    wx.navigateTo({ url: '/subPkg3/activity/create/create' })
  },

  // 去审核
  onGoAudit: function () {
    wx.navigateTo({ url: '/subPkg3/activity/audit/audit' })
  },

  // 我的活动
  onMyActivities: function () {
    wx.navigateTo({ url: '/subPkg3/activity/myactivity/myactivity' })
  },
