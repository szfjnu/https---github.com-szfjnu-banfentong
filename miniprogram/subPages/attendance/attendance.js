...
Page({
  ...
  onShowStudentList: function () {
    ...
    wx.navigateTo({
      url: `/subPages/attendance/record/record?class_id=${this.data.classId}&date=${this.data.selectedDate}&mode=edit`
    });
  },
  ...
  onNavToRecord: function () {
    wx.navigateTo({
      url: `/subPages/attendance/record/record?class_id=${this.data.classId}`
    });
  },
  ...
  onNavToLeaveApproval: function () {
    wx.navigateTo({
      url: `/subPages/attendance/leave/leave?class_id=${this.data.classId}`
    });
  },
