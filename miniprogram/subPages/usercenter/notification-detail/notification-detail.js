...
Page({
  ...
  onAction: function () {
    ...
    const actionMap = {
      view_discipline: '/subPages/discipline/discipline',
      view_grade: '/subPages/grade/grade',
      view_transfer: '/pages/transfer/transfer',
      view_treehole: '/subPages/treehole/treehole',
      view_market: '/pages/market/market',
      view_score: '/pages/score/score',
      view_attendance: '/subPages/attendance/attendance',
      view_duty: '/subPages/duty/duty',
      view_dorm: '/subPages/dorm/dorm',
      view_volunteer: '/subPages/volunteer/volunteer',
      view_approval: '/subPages/approval/approval'
    };
