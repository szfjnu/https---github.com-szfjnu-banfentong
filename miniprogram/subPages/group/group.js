...
Page({
  ...
  viewGroupDetail: function () {
    ...
    wx.navigateTo({
      url: `/subPages/group/add/add?id=${group._id}&mode=view`
    });
  },
  ...
  editGroup: function () {
    ...
    wx.navigateTo({
      url: `/subPages/group/add/add?id=${group._id}&mode=edit`
    });
  },
  ...
  viewGroupStudents: function () {
    ...
    wx.navigateTo({
      url: `/subPages/group/add/add?id=${group._id}&mode=members`
    });
  },
