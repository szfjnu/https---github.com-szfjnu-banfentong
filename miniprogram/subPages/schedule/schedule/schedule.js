...
Page({
  ...
  goToImport: function () {
    wx.navigateTo({
      url: `/subPages/schedule/import/import?class_id=${this.data.classId}&class_name=${encodeURIComponent(this.data.className)}&semester_name=${encodeURIComponent(this.data.semesterName)}`
    })
  }
})
