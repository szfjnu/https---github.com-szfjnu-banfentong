...
Page({
  ...
  onItemClick(e) {
    ...
    wx.navigateTo({ url: '/subPkg1/skill-cert/detail/detail?record_id=' + recordId })
  },

  onAdd() {
    wx.navigateTo({ url: '/subPkg1/skill-cert/add/add' })
  },

  onApprove() {
    wx.navigateTo({ url: '/subPkg1/skill-cert/approve/approve' })
  },

  onConfig() {
    wx.navigateTo({ url: '/subPkg1/skill-cert/score-rules/score-rules' })
  }
})