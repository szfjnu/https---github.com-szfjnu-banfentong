...
Page({
  ...
  onViewVersions: function (e) {
    ...
    wx.navigateTo({
      url: `/subPkg1/score/rules/version?rule_id=${rule.record_id}&rule_name=${encodeURIComponent(rule.rule_name || rule.name || '规则')}`
    });
  },
  ...
  onManageCategories: function () {
    wx.navigateTo({
      url: '/subPkg1/score/categories/categories'
    });
  }
});
