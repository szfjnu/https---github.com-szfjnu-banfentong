...
Page({
  ...
  goLayout: function () {
    wx.navigateTo({ url: '/subPkg4/seat/layout/layout' })
  },

  goArrange: function () {
    wx.navigateTo({ url: '/subPkg4/seat/arrange/arrange' })
  },

  goRotate: function () {
    wx.navigateTo({ url: '/subPkg4/seat/rotate/rotate' })
  },

  goHistory: function () {
    wx.navigateTo({ url: '/subPkg4/seat/history/history' })
  },
