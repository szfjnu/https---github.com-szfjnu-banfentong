...
Page({
  ...
  onAddStudent: function () {
    ...
    // 跳转到确认页，标记为添加新学生
    wx.navigateTo({
      url: `/subPkg5/join/confirm/confirm?classId=${this.data.classId}&role=parent&addNew=true`
    });
  },
  ...
  onNext: function () {
    ...
    // 跳转到确认页
    wx.navigateTo({
      url: `/subPkg5/join/confirm/confirm?classId=${this.data.classId}&role=parent&studentId=${this.data.selectedStudentId}`
    });
  }
});
