...
Page({
  ...
  onRecordDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/score/record/detail/detail?id=${id}`
    });
  },
  ...
  onAppeal: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/score/appeal/appeal?recordId=${record._id}&studentId=${record.student_id}`
    });
  },
  ...
  onViewAnomalies: function () {
    wx.navigateTo({
      url: '/pages/score/anomaly/anomaly'
    });
  }
});
