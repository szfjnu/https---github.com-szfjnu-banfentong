...
Page({
  ...
  loadStats: async function () {
    try {
      ...
      // 并行加载多个统计数据
      const [studentRes, rulesRes, recordsRes, warningsRes] = await Promise.all([
        // 1. 统计住宿生数量和平均分
      ...
      const formattedRecords = recordsRes.data.map(record => {
        ...
        return {
          ...
          score_display: record.score_value,
  ...
  goToBuildings: function () {
    wx.navigateTo({
      url: '/pages/dorm/buildings/buildings'
    });
  },

  goToRules: function () {
    wx.navigateTo({
      url: '/pages/dorm/rules/rules'
    });
  },

  goToInspection: function () {
    wx.navigateTo({
      url: '/pages/dorm/score/records/records'
    });
  },

  goToInspectionAdd: function () {
    wx.navigateTo({
      url: '/pages/dorm/score/add/add'
    });
  },

  goToStatistics: function () {
    wx.navigateTo({
      url: '/pages/dorm/statistics/statistics'
    });
  },
  ...
  goToWarnings: function () {
    wx.navigateTo({
      url: '/pages/dorm/statistics/statistics?tab=warnings'
    });
  },
  ...
  viewRecordDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/dorm/inspection/inspection?id=${id}`
    });
  },
  ...
  viewStudentDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/dorm/detail/detail?student_id=${studentId}`
    });
  },
