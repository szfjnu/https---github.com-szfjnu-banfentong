...
Page({
  ...
  onViewDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/pages/dorm/beds/beds?room_id=${id}`
    });
  },
  ...
  onEdit: function (e) {
    const id = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: `/pages/dorm/rooms/add/add?id=${id}&building_id=${this.data.buildingId}`
    });
  },
  ...
  onAdd: function () {
    wx.navigateTo({
      url: `/pages/dorm/rooms/add/add?building_id=${this.data.buildingId}`
    });
  },
