...
Page({
  ...
  onShowStudentList: function () {
    ...
    wx.navigateTo({
      url: `/pages/attendance/record/record?class_id=${this.data.classId}&date=${this.data.selectedDate}&mode=edit`
    });
  },
  ...
  onNavToRecord: function () {
    wx.navigateTo({
      url: `/pages/attendance/record/record?class_id=${this.data.classId}`
    });
  },
  ...
  onNavToSettings: function () {
    wx.navigateTo({
      url: `/pages/attendance/settings/settings?class_id=${this.data.classId}`
    });
  },
  ...
  onNavToLeaveApproval: function () {
    wx.navigateTo({
      url: `/pages/attendance/leave/leave?class_id=${this.data.classId}`
    });
  },
  ...
  onNavToFullAttendance: function () {
    wx.navigateTo({
      url: `/pages/attendance/fullstats/fullstats?class_id=${this.data.classId}`
    });
  },
