...
Page({
  ...
  goToSettings: function () {
    wx.navigateTo({
      url: `/subPkg1/class/settings/settings?id=${this.data.classId}`
    });
  },

  goToBuildings: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/buildings/buildings'
    });
  },

  goToRules: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/rules/rules'
    });
  },

  goToInspection: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/score/records/records'
    });
  },

  goToInspectionAdd: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/score/add/add'
    });
  },

  goToStatistics: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/statistics/statistics'
    });
  },
  ...
  goToWarnings: function () {
    wx.navigateTo({
      url: '/subPkg2/dorm/statistics/statistics?tab=warnings'
    });
  },
  ...
  viewRecordDetail: function (e) {
    ...
    if (record && record.student_id) {
      ...
      wx.navigateTo({
        url: `/subPkg2/dorm/detail/detail?student_id=${record.student_id}&highlight_record=${recordId}`
      });
    } else {
      wx.showToast({
        title: '记录详情暂不可用',
  ...
  viewStudentDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/subPkg2/dorm/detail/detail?student_id=${studentId}`
    });
  },
