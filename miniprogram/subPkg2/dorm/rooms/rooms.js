...
Page({
  ...
  onViewDetail: function (e) {
    ...
    wx.navigateTo({
      url: `/subPkg2/dorm/beds/beds?room_id=${id}`
    });
  },
  ...
  onEdit: function (e) {
    const id = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: `/subPkg2/dorm/rooms/add/add?id=${id}&building_id=${this.data.buildingId}`
    });
  },
  ...
  onAdd: function () {
    wx.navigateTo({
      url: `/subPkg2/dorm/rooms/add/add?building_id=${this.data.buildingId}`
    });
  },
